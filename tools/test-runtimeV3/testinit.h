...
DEFINE_ACCMUT_FUNC(rename);
DEFINE_ACCMUT_FUNC(remove);
DEFINE_ACCMUT_FUNC(unlink);
DEFINE_ACCMUT_FUNC(link);
DEFINE_ACCMUT_FUNC(dup);
DEFINE_ACCMUT_FUNC(access);
...
ADD_ACCMUT_FUNC(rename);\
ADD_ACCMUT_FUNC(remove);\
ADD_ACCMUT_FUNC(unlink);\
ADD_ACCMUT_FUNC(link);\
ADD_ACCMUT_FUNC(dup);\
ADD_ACCMUT_FUNC(access);\
