...
int MSInstrumenter::instrument(Function &F, vector<Mutation *> *v, int index, int mut_from, int mut_to,
                               int instrumented_insts) {
    int insts = 0;
...
static RegisterPass<MSInstrumenter> X("AccMut-schemata", "AccMut - Instrument Code to Mutation Schemata");
/*-----------------reserved end --------------------*/
