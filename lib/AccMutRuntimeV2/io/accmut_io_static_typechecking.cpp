//
// Created by Sirui Lu on 2019-03-17.
//

#include <type_traits>
#include <llvm/AccMutRuntimeV2/io/accmut_io_stdio.h>
#include <llvm/AccMutRuntimeV2/io/accmut_io_unix.h>
#include <fcntl.h>
...
template <>\
struct accmut_same<a,a> : public std::true_type {}
#define DECLARE_SAME(a, b) \
template <>\
struct accmut_same<a,b> : public std::true_type {};\
template <>\
struct accmut_same<b,a> : public std::true_type {}
...
template<typename _T, typename _T1, typename _U, typename _U1>
struct accmut_same<_T(_T1, ...), _U(_U1, ...)> :
        accmut_same<_T(_T1), _U(_U1)> {
};

template<
        typename _T, typename _T1, typename _T2,
        typename _U, typename _U1, typename _U2>
...
template<
        typename _T, typename _T1, typename _T2, typename _T3,
        typename _U, typename _U1, typename _U2, typename _U3>
struct accmut_same<_T(_T1, _T2, _T3), _U(_U1, _U2, _U3)> :
        conjunction<accmut_same<_T(_T1, _T2), _U(_U1, _U2)>, accmut_same<_T3, _U3>> {
};
...
template<
        typename _T, typename _T1, typename _T2, typename _T3, typename _T4,
        typename _U, typename _U1, typename _U2, typename _U3, typename _U4>
struct accmut_same<_T(_T1, _T2, _T3, _T4), _U(_U1, _U2, _U3, _U4)> :
        conjunction<accmut_same<_T(_T1, _T2, _T3), _U(_U1, _U2, _U3)>, accmut_same<_T4, _U4>> {
};
...
#define TEST_TYPE(func) \
    static_assert(accmut_same<decltype(func), decltype(__accmutv2__ ## func)>::value, #func)
